...
def full_query_pipeline(user_query, index, embeddings_model, system_prompt_path, chat_model):
    ...
    output_dict = format_rag_response(response_text, retrieved_chunks, system_prompt, user_prompt)
